...
def play_selected_track():
    pygame.mixer.music.load(tracks[current_track_index]["file"])
...
pygame.display.set_icon(pygame.image.load("Fluxoid_Logo.png"))
menu_logo = pygame.transform.scale(pygame.image.load("Fluxoid_Logo.png"), (200, 200))
